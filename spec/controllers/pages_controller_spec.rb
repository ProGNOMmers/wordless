...
describe Administration::PagesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created page" do
        post :create, {:page => valid_attributes}, valid_session
        expect(response).to redirect_to(administration_page_path(Page.last))
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested page" do
        ...
        Page.any_instance.should_receive(:update).with({ "title" => "Title" })
        put :update, {:id => page.to_param, :page => { "title" => "Title" }}, valid_session
      end
      ...
      it "redirects to the page" do
        page = Page.create! valid_attributes
        put :update, {:id => page.to_param, :page => valid_attributes}, valid_session
        expect(response).to redirect_to(administration_page_path(page))
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the pages list" do
      page = Page.create! valid_attributes
      delete :destroy, {:id => page.to_param}, valid_session
      expect(response).to redirect_to(administration_pages_url)
    end
  end
